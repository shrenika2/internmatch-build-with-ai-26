...
import { Briefcase, LogOut, LayoutDashboard, ShieldCheck, BarChart3, Users } from 'lucide-react';
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-2">
                            ...
                            <Link to="/admin/dashboard" className="px-3 py-2 rounded-md text-[11px] font-black uppercase tracking-widest transition-colors text-red-500 bg-red-500/10">
                                Admin
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        <Link to="/admin/dashboard" className="flex items-center gap-2 text-slate-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
