                ...
                <div className="flex flex-col md:flex-row items-center gap-12 relative">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-6 text-slate-500 font-bold text-xs uppercase tracking-widest">
                            ...
                            <div className="flex items-center gap-2"><Building2 className="w-4 h-4" /> PCCOE | {profile.collegeId}</div>
                            <div className="flex items-center gap-2 font-black text-slate-300"><Mail className="w-4 h-4" /> {profile.user?.email}</div>
                        </div>
                    </div>
